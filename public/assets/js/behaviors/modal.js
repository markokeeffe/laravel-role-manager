/**
 * Modal behavior - Generate a bootstrap modal from returned heading and content
 *
 *
  <div class="modal fade" data-behavior="modal">
 ...
 *
 * @param $modal The modal container
 *
 */
MOK.Behaviors.modal = function($modal){
  ...
  MOK.Functions.modal = function(content, no_close){
